...
jQuery(document).ready(function($) {
    ...
    function calculateLoanRepayments() {
        ...
        const repayment = LCS.calculateLoanRepayment(loanAmount, interestRate, loanTerm, repaymentFrequency);
        
        // Calculate total interest and fees
        const totalInterest = calculateTotalInterestAndFees(loanAmount, repayment, loanTerm, interestRate, loanFee, loanFeeFrequency, repaymentFrequency);
        ...
        $('#monthly-repayment-result').text(LCS.formatCurrency(repayment));
        $('#total-interest-result').text(LCS.formatCurrency(totalInterest));
        $('#total-payments-result').text(LCS.formatCurrency(totalPayments));
        
        // Update chart
        updateChart(loanAmount, interestRate, loanTerm, repayment, loanFee, loanFeeFrequency, repaymentFrequency);
