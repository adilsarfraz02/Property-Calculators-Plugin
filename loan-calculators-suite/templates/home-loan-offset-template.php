<?php
/**
 * Home Loan Offset Calculator Template
 *
...
<div class="lcs-calculator home-loan-offset-calculator">
	<h2 class="lcs-calculator-title">Home Loan Offset Calculator</h2>
	...
	<div class="lcs-calculator-container">
		...
		<div class="lcs-input-section">
			...
			<div class="lcs-input-group offset-account-field">
				<label for="offset-amount">Offset Account Balance</label>
				<div class="lcs-input-wrapper">
					<span class="lcs-currency-symbol">$</span>
					<input type="text" id="offset-amount" value="10000" />
				</div>
			</div>
		</div>
		...
		<div class="lcs-chart-section">
			...
			<div class="lcs-chart-legend">
				<div class="lcs-legend-item">
					...
					<span class="lcs-legend-label">With Offset</span>
				</div>
				<div class="lcs-legend-item">
					<span class="lcs-legend-color" style="background-color: rgba(51, 51, 51, 0.8);"></span>
					<span class="lcs-legend-label">Without Offset</span>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="lcs-results-section">
		...
		<div class="lcs-result-details">
			<div class="lcs-result-item">
				<span class="lcs-result-label">Standard Repayment</span>
				<span id="standard-repayment-result" class="lcs-result-value">$2,271.16</span>
			</div>
			
			<div class="lcs-result-item">
				<span class="lcs-result-label">Effective Repayment</span>
				<span id="effective-repayment-result" class="lcs-result-value">$2,225.74</span>
			</div>
			
			<div class="lcs-result-item">
				<span class="lcs-result-label">Time Saved</span>
				<span id="time-saved-result" class="lcs-result-value">1 year, 3 months</span>
			</div>
			
			<div class="lcs-result-item">
				<span class="lcs-result-label">Interest Saved</span>
				<span id="interest-saved-result" class="lcs-result-value">$25,000.00</span>
			</div>
		</div>
		...
		<div class="lcs-modal-content">
			...
			<div class="lcs-modal-body">
				<div class="lcs-modal-section">
					<h4>Description</h4>
					<p>This calculator helps you find out how much time and interest you could save by using an offset account with your home loan.</p>
				</div>
				...
				<div class="lcs-modal-section">
					...
					<ul>
						...
						<li>The offset account balance remains constant throughout the loan term.</li>
						<li>Interest is calculated on the loan balance minus the offset account balance.</li>
					</ul>
				</div>
			</div>
