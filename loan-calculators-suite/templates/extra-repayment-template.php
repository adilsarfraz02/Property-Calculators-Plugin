<?php
/**
 * Extra Repayment Calculator Template
 *
...
<div class="lcs-calculator extra-repayment-calculator">
	<h2 class="lcs-calculator-title">Extra Repayment Calculator</h2>
		...
		<div class="lcs-input-section">
			...
			<div class="lcs-input-group">
				...
				<div class="lcs-input-wrapper">
					...
					<input type="text" id="loan-amount" value="350000" />
				</div>
			</div>
			...
			<div class="lcs-input-group extra-contribution-field">
				<label for="extra-amount">Extra contribution per payment</label>
				<div class="lcs-input-wrapper">
					<span class="lcs-currency-symbol">$</span>
					<input type="text" id="extra-amount" value="100" />
				</div>
			</div>
		</div>
		...
		<div class="lcs-chart-section">
			...
			<div class="lcs-chart-legend">
				<div class="lcs-legend-item">
					...
					<span class="lcs-legend-label">With Extra</span>
				</div>
				<div class="lcs-legend-item">
					<span class="lcs-legend-color" style="background-color: rgba(51, 51, 51, 0.8);"></span>
					<span class="lcs-legend-label">Base Loan</span>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="lcs-results-section">
		...
		<div class="lcs-result-details">
			<div class="lcs-result-item">
				<span class="lcs-result-label">Minimum Repayment</span>
				<span id="minimum-repayment-result" class="lcs-result-value">$2,271.16</span>
			</div>
			
			<div class="lcs-result-item">
				<span class="lcs-result-label">Increased Repayment</span>
				<span id="increased-repayment-result" class="lcs-result-value">$2,371.16</span>
			</div>
			
			<div class="lcs-result-item">
				<span class="lcs-result-label">Time Saved</span>
				<span id="time-saved-result" class="lcs-result-value">2 years, 1 month</span>
			</div>
			
			<div class="lcs-result-item">
				<span class="lcs-result-label">Interest Saved</span>
				<span id="interest-saved-result" class="lcs-result-value">$50,000.00</span>
			</div>
		</div>
		...
		<div class="lcs-modal-content">
			...
			<div class="lcs-modal-body">
				<div class="lcs-modal-section">
					<h4>Description</h4>
					<p>This calculator helps you find out how much time and interest you could save by making extra repayments on your loan.</p>
				</div>
				
				<div class="lcs-modal-section">
					<h4>Assumptions</h4>
					<ul>
						<li>It does not take into account any possible fees, upfront fees or ongoing fees.</li>
						...
						<li>It is assumed that your lender considers 48 weeks which is equivalent to 12 months in a year.</li>
						<li>No rounding of the actual payment amount is done to keep the "term" strict in practice.</li>
						<li>Extra repayments are made consistently with each regular payment throughout the loan term.</li>
					</ul>
				</div>
			</div>
